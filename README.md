...
## Background:
BloodpartML (Blood Particle Machine Learning) was developed on my microbubble-assisted focused ultrasound (MBFUS) data to automate the detection and analysis of exogenous particles in large (>1,000 image) whole blood datasets.
